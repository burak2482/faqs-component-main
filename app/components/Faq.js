  ...
  const faqs = [
    {
      ...
      content: 'Frontend Mentor offers realistic coding challenges to help developers improve their frontend coding skills with projects in HTML, CSS, and JavaScript. Its suitable for all levels and ideal for portfolio building.'
    },
    {
    ...
    {
      title: 'How can I get help if Im stuck on a Frontend Mentor challenge?',
